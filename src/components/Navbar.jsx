        ...
        <>
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 h-[70px] lg:h-[80px] overflow-hidden border-b border-white/10">
                ...
                <div className="relative z-10 h-full px-6 lg:px-16 flex items-center justify-between">
                    ...
                    <Link
                        to="/"
                        className="text-portfolio-cream font-rockybilly text-[17px] md:text-[17px] font-normal leading-[1.3] font-features-['liga'_off,'clig'_off] hover:opacity-80 transition-opacity mt-4"
                    >
                        Baskey Koer
                    </Link>
                    ...
                    <div className="hidden lg:flex items-center gap-6">
                        <NavLink
                            to="/"
                            className={({ isActive }) =>
                                `text-portfolio-cream font-epilogue font-medium text-base h-10 px-3 flex items-center transition-all ${isActive ? "pb-1 border-b-2 border-portfolio-coral" : "hover:border-b-2 hover:border-portfolio-coral"
                                }`
                            }
                        >
                            Home
                    ...
                    >
                        ...
                        <ArrowUpRight01Icon size={20} className="shrink-0" variant="soft" />
                    </Link>
                    ...
                    <div className="relative z-10 min-h-full flex flex-col p-6 max-w-md mx-auto">
                        ...
                        <div className="flex flex-col w-full px-2">
                            <NavLink
                                ...
                                onClick={() => setIsMenuOpen(false)}
                                className={({ isActive }) =>
                                    `flex items-center gap-4 text-white font-epilogue font-medium text-[16px] pb-5 border-b-2 mb-6 ${isActive ? "border-portfolio-coral" : "border-transparent"
                                    }`
                                }
                            >
                                <Home01Icon size={22} className="text-white" variant="soft" />
                                Home
                            </NavLink>
                            ...
                            >
                                <UserIcon size={22} className="text-white" variant="soft" />
                                About
                            </NavLink>
                            ...
                            <NavLink
                                ...
                                onClick={() => setIsMenuOpen(false)}
                                className={({ isActive }) =>
                                    `flex items-center gap-4 text-white font-epilogue font-medium text-[16px] pb-5 border-b-2 mb-8 ${isActive ? "border-portfolio-coral" : "border-transparent"
                                    }`
                                }
                            >
                                <ShoppingBag01Icon size={22} className="text-white" variant="soft" />
                                My Work
                            </NavLink>
