...
export function AboutSection() {
    ...
    return (
        <section className="relative w-full min-h-[1252px]">
            {/* Split Background */}
            <div className="absolute inset-0 flex flex-col pointer-events-none">
                <div
                    className="h-[70%] w-full bg-cover bg-bottom"
            ...
            <div className="relative max-w-7xl mx-auto px-8 md:px-10 w-full pt-16 md:pt-40 pb-12 md:pb-16 flex justify-between flex-col min-h-[1252px]">
                ...
                {/* Stats Cards */}             
                <div className="w-full rounded-[22px] border-[1.5px] border-[#DBBCAC] bg-transparent p-2.5">
                    <div className="grid grid-cols-1 sm:grid-cols-3 divide-y-[1.5px] sm:divide-y-0 sm:divide-x-[1.5px] divide-[#DBBCAC]">
                        {stats.map((stat, i) => (
                            <div
                                key={i}
                                className="flex items-center justify-between px-8 py-9 md:px-10 gap-4"
                            >
                                {/* Text */}
                                <div>
                                    <p
                                        className="font-extrabold text-[42px] text-portfolio-dark leading-none tracking-tight"
                                        style={{ fontFamily: "'Epilogue', sans-serif" }}
                                    >
                                        {stat.value}
                                    </p>
                                    <p
                                        className="text-[15px] text-[#a8a4a0] mt-2 font-normal whitespace-nowrap"
                                        style={{ fontFamily: "'Epilogue', sans-serif" }}
                                    >
                                        {stat.label}
                                    </p>
                                ...
                                {/* Icon circle */}
                                <div
                                className={`w-[76px] h-[76px] rounded-full flex items-center justify-center flex-shrink-0 ${stat.circleBg}`}
                                >
                                    {stat.icon}
                                </div>
                            </div>
